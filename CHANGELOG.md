...
- Refactor color, embeds, arguments 
- Feat: re-implemented dadbot! 
- Sorted categories in dropdown menu and fixed cmd aliases display in list 

## v6.0.2-0 - 2023-04-23

### Commits

- Commandlist probably works 100% now 
- Moved all sapphire augmentations to it's own Extension file 
- Renamed client 
