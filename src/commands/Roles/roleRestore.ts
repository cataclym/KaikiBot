        ...
        if (!result) {
            ...
            return message.channel.send({
                embeds: [
                    new EmbedBuilder()
                        .setDescription(
                            `Restored roles of \`${member.user.username}\` [${member.id}]`
                        )
                        .addFields({
                            name: "Roles added",
            ...
            return message.channel.send({
                embeds: [
                    new EmbedBuilder()
                        .setDescription(
                            "This member already has all the roles."
                        )
            ...
            return message.channel.send({
                embeds: [
                    new EmbedBuilder()
                        .setDescription(
                            "This user's roles have not been saved, or they have not left the guild."
                        )
                        .withErrorColor(message),
                ],
            });
