...
export const tableQueries = {
    ...
    DiscordUsers: "CREATE TABLE IF NOT EXISTS `DiscordUsers` (`Id` BIGINT NOT NULL auto_increment , `UserId` VARCHAR(255) NOT NULL UNIQUE, `Amount` BIGINT DEFAULT 0, `CreatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`Id`)) ENGINE=InnoDB; ",
